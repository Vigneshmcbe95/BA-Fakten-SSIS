            ...
            For Each v As VerfahrenInfo In verfahren
                ...
                Try
                    ...
                    For Each pe As PartitionsEintrag In meineWerte
                        ...
                        ' _in Tabelle erstellen
                        SqlAusfuehren(connStr,
                            "IF EXISTS(SELECT 1 FROM sys.tables WHERE schema_id=SCHEMA_ID('dbo') AND name='" & inTabelle & "') DROP TABLE dbo.[" & inTabelle & "];",
                            "_in loeschen")
                        SqlAusfuehren(connStr,
                            "CREATE TABLE dbo.[" & inTabelle & "] (" & vbCrLf & spaltenListe & vbCrLf & ");",
                            "_in erstellen")
                        ...
                        Log("  _in/_out erstellt: " & pvStr & " | Modus: " & pe.Modus)
                        cntStaging += 1
                    Next
