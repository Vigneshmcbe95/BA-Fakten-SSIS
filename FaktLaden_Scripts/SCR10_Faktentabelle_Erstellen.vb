...
' =============================================================================
'  Skript       : SCR10_Faktentabelle_Erstellen
'  Paket        : Fakten Laden (SSIS)
'  Zweck        : Erstellt die partitionierte Faktentabelle inkl.
'                 Partitionsfunktion / -schema und Clustered Columnstore
'                 Index; vorhandene gueltige Tabellen werden uebersprungen.
'  Ablauf       : EXT_TABELLE_ERSTELLT -> FAKTENTABELLE_ERSTELLT
...
Partial Public Class ScriptMain
    ...
    Private Const SKRIPT_NAME As String = "SCR10_Faktentabelle_Erstellen"
    ...
    ' -----------------------------------------------------------------------
    ' FaktentabelleErstellen - Erstellt Partitionsfunktion / -schema, die
    ' Faktentabelle und den Clustered Columnstore Index.
    ' -----------------------------------------------------------------------
