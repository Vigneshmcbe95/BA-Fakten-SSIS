...
'          2. Zeilenweise verarbeiten â Tabellenname ableiten
...
Partial Public Class ScriptMain
    ...
    Public Sub Main()
        ...
        Log("SCR_02_Steuerlisten_Laden â Start")
        ...
        Try
            ...
            Log("VollstÃ¤ndiger Pfad : " & dateipfad)
            ...
            For Each dp As String In alleDateien
                ...
                Try
                    ...
                    cntErfolgreich += 1
                    Log("Datei erfolgreich verarbeitet: " & dateiname & " â")
            ...
            If cntFehlerhaft > 0 Then
                ...
                Dts.TaskResult = ScriptResults.Failure
            Else
                Log("Datei erfolgreich verarbeitet â")
    ...
    Private Function PflichtfelderPruefen() As Boolean
        ...
        If String.IsNullOrEmpty(_stlOrdner) Then fehlend.AppendLine("  â BA::STLOrdner")
        If String.IsNullOrEmpty(_stlDateiname) Then fehlend.AppendLine("  â BA::STLDateiname")
    ...
    ' =========================================================================
    ' ZusÃ¤tzliche Spalten in tm_steuerlistenfile_Fakten sicherstellen
    ' =========================================================================
...
-- Fehlende Spalten nachtrÃ¤glich hinzufÃ¼gen (Idempotent)
...
IF NOT EXISTS (SELECT 1 FROM sys.columns WHERE object_id = OBJECT_ID('dbo." & _steuerlistenTabelle & "') AND name = 'ref_datum')
    ALTER TABLE dbo." & _steuerlistenTabelle & " ADD ref_datum DATETIME NULL;"
        ...
        Log("Tabelle und Spalten geprÃ¼ft/angelegt â")
    ...
    Private Sub VerarbeiteDatei(dateipfad As String,
        ...
        Log(String.Format("  Zeilen gesamt: {0} | INSERT: {1} | UPDATE: {2} | Ãbersprungen: {3}",
    ...
    ' =========================================================================
    ' Parameter aus anonymem Objekt zu SqlCommand hinzufÃ¼gen
    ' =========================================================================
