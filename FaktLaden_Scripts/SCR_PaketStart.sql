...
Partial Public Class ScriptMain
    ...
    Public Sub Main()
        ...
        Try
            ...
            Log("── Schritt 3: ETL_Fkt_Arbeitsliste FEHLER/LAUFEND → AUSSTEHEND")
            ...
            ' -- Schritt 5: Unvollständige Verfahren auf neue RunID setzen ----
            Log("── Schritt 5: Unvollständige Verfahren auf neue RunID setzen")
            VerfahrenAdoptieren(connStr, runID)
