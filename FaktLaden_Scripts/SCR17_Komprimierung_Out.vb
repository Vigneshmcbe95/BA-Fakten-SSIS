...
' =============================================================================
'  Script   : SCR17_Komprimierung_Out
'  Package  : Fakten Laden (SSIS)
'  Purpose  : Applies PAGE / ROW compression to the _out_ staging tables
'             when configured (not applicable for CCI).
'  Workflow : INDEX_IN_OUT_ERSTELLT -> KOMPRIMIERUNG_ERSTELLT
