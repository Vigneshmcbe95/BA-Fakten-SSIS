...
'          Status: SCHEMADATEN_KOPIERT â TEMPLATE_ERSTELLT
' =============================================================================
...
Partial Public Class ScriptMain
    ...
    Public Sub Main()
        ...
        Log("SCR06_Template_Erstellen â Start (v5: Direct from Oracle)")
...
ORDER BY ddl.COLNO;"
        ...
        Log("  â Template erfolgreich: " & ziel & " | Spalten: " & cnt.ToString())
    End Sub
