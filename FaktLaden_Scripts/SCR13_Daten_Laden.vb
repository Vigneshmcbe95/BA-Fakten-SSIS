...
Partial Public Class ScriptMain
    ...
    Private Function DatenLadenSelectInto(connStr As String, v As VerfahrenInfo,
        ...
        ' Typ-/Nullability-/Collation-Abweichung mehr (z.B. decimal(38,0) der
        ' ext-Quelle vs. decimal(17,10) der Faktentabelle). Die Faktentabelle
        ' ist die massgebliche Struktur (Template wird manuell gepflegt).
