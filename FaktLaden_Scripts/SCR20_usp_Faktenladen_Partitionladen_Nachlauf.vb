...
' =============================================================================
'  Skript       : SCR20_usp_Faktenladen_Partitionladen_Nachlauf
'  Paket        : Fakten Laden (SSIS)
'  Zweck        : Fuehrt die optionale Nachlauf-Prozedur
'                 usp_Faktenladen_Partitionladen_Nachlauf_<fakt> je
'                 Partition aus, sofern vorhanden.
'  Ablauf       : ERFOLG -> NACHLAUF_PART_ERFOLG
...
Partial Public Class ScriptMain
    ...
    Private Const SKRIPT_NAME As String = "SCR20_usp_Faktenladen_Partitionladen_Nachlauf"
    ...
    Public Sub Main()
        ...
        Log("SCR20_usp_Faktenladen_Partitionladen_Nachlauf - Start")
        ...
        Try
            ...
            ' Verfahren aus ETL_Fakt_Arbeitsliste laden
            ...
            For Each v As VerfahrenInfo In verfahren
                ...
                Dim procName As String = "usp_Faktenladen_Partitionladen_Nachlauf_" & v.Verfahren
