...
'          Status: AUSSTEHEND â SCHEMADATEN_KOPIERT
'          STAGING TABLE BLEIBT ERHALTEN (fÃ¼r Debugging)
' =============================================================================
...
Partial Public Class ScriptMain
    ...
    Public Sub Main()
        ...
        Log("SCR05_Schemadaten_Kopieren â Start")
        ...
        Try
            ...
            ' 4. FÃ¼r jedes Verfahren: Daten aus Staging in tm_polybase_struktur kopieren
            ...
            For Each v As VerfahrenInfo In verfahren
                ...
                Try
                    ...
                    If rows = 0 Then
                        Log("  WARNUNG: Keine Schemadaten fÃ¼r " & v.Themengebiet & "." & v.Verfahren)
                    ...
                    Else
                        ...
                        cntOK += 1
                        Log("  â " & rows.ToString() & " Spalten kopiert â")
                    End If
            ...
            ' 5. STAGING BLEIBT ERHALTEN - nicht lÃ¶schen!
            Log("ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ")
            Log("Staging-Tabelle dbo.ddl_staging bleibt fÃ¼r Debugging erhalten")
            Log("ââââââââââââââââââââââââââââââââââââââââââââââââââââââââ")
    ...
    Private Sub StageOracleData(connStr As String)
        ...
        ' PrÃ¼fen ob Staging bereits existiert
        ...
        Log("Oracle-Abfrage lÃ¤uft (kann 20-60 Sekunden dauern)...")
...
FROM [" & _datenbank & "].[" & _extTableSchema & "].[" & _extTableName & "];"
    ...
    ' ==========================================================================================
    ' EINE TABELLE AUS STAGING EINFÃGEN - SIMPLIFIED
    ' ==========================================================================================
...
END;"
        ...
        Log("Ziel-Tabelle tm_polybase_struktur geprÃ¼ft/erstellt.")
    End Sub
